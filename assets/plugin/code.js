...
figma.ui.onmessage = async (msg) => {
	...
	if (msg.type === "connected") {
		figma.notify("✓ Figma CLI connected", { timeout: 2000 });
	}

	if (msg.type === "disconnected") {
		figma.notify("Figma CLI disconnected", { timeout: 2000 });
	}

	if (msg.type === "error") {
		figma.notify("Figma CLI: " + msg.message, { error: true });
	}
};
...
console.log("Figma CLI plugin started");
